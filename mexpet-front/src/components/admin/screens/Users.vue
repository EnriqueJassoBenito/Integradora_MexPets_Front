<template>
    ...
    <div class="col">
      <b-form-select v-model="filtroRol" :options="opcionesRoles" placeholder="Filtrar por Rol" style="height:38px; border-radius: 5px;"></b-form-select>
    </div>
    <div class="col">
            <b-button variant="success" @click="mostrarModalAgregarModeradorFn" class="ml-auto">Agregar Moderador</b-button>
          </div>
        </div>
