    ...
    <b-navbar toggleable="lg" type="dark" variant="dark" class="navbar">
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          ...
          >
            <b-dropdown-item
              :to="{ name: 'registration-requests-standby' }"
              @click="selectOption('registration-requests-standby')"
            >
              En espera
            </b-dropdown-item>
            <b-dropdown-item
              :to="{ name: 'registration-requests-proccess' }"
          ...
          >
            <b-dropdown-item
              :to="{ name: 'awaiting-requests' }"
              @click="selectOption('awaiting-requests')"
            >
              En espera
            </b-dropdown-item>
            <b-dropdown-item
              :to="{ name: 'adoption-requests-process' }"
          ...
          <b-nav-item
            :to="{ name: 'management-adoptions' }"
            @click="selectOption('management-adoptions')"
            :class="{ active: selectedOption === 'management-adoptions' }"
            >Mis gestiones</b-nav-item
          >
        </b-navbar-nav>
