        ...
        <b-row>
          <b-col cols="4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="nameUser" v-model="currentUser.user.nameUser"
                :disabled="!isEditing" />
            </div>
          </b-col>
          <b-col cols="4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="name" v-model="currentUser.user.name"
                :disabled="!isEditing" />
            </div>
          </b-col>
          <b-col cols="4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="lastname" v-model="currentUser.user.lastname"
                :disabled="!isEditing" />
            </div>
          </b-col>
        </b-row>
        <b-row>
          <b-col cols="4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="lastnameMatern" v-model="currentUser.user.lastnameMatern"
                :disabled="!isEditing" />
            </div>
          </b-col>
          <b-col cols="4">
            <div class="form-group">
              ...
              <input type="email" class="form-control" id="email" v-model="currentUser.user.email"
                :disabled="!isEditing" />
            </div>
          </b-col>
          <b-col cols="4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="phoneNumber" v-model="currentUser.user.phoneNumber"
                :disabled="!isEditing" />
            </div>
          </b-col>
        </b-row>
        <b-row>
          <b-col cols="4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="localitation" v-model="currentUser.user.localitation"
                :disabled="!isEditing" />
            </div>
          </b-col>
          <b-col cols="4">
  ...
  methods: {
    async fetchCurrentUser() {
      ...
      if (userData) {
        ...
        if (currentUserData.user.rol && currentUserData.user.rol.nrol === "MODERADOR") {
    ...
    async saveChanges() {
      ...
      if (confirmed.isConfirmed) {
        try {
          ...
          const adminRol = roles.find(rol => rol.nrol === "MODERADOR");
          ...
          this.$router.push({ name: 'profile-moderator' });
        }
      }
    }
  },
